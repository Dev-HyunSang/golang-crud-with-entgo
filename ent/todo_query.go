...
func (tdgb *ToDoGroupBy) Scan(ctx context.Context, v interface{}) error {
...
func (tdgb *ToDoGroupBy) sqlScan(ctx context.Context, v interface{}) error {
...
func (tds *ToDoSelect) Scan(ctx context.Context, v interface{}) error {
...
func (tds *ToDoSelect) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}
